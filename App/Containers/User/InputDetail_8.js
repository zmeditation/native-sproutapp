...
import {change}
  from 'redux-form'
import Screen
  from '../../Components/User/InputDetail_8'
import {SPROUT}
...
const handleLocalAction = (dispatch, action, navigation) => {
  ...
  switch (type) {
    case localActions.UPDATE_INVESTOR_TYPE:
...
export const localActions = {
  ...
  UPDATE_INVESTOR_TYPE: 'UPDATE_INVESTOR_TYPE'
}
...
const mapStateToProps = (state, props) => {
  ...
  return {
    ...
    nextScreen: SPROUT.USER_INPUT_DETAIL_9,
