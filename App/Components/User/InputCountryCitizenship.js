...
import PropTypes
  from 'prop-types'
import { View, Text, Keyboard, ScrollView, ActivityIndicator }
  from 'react-native'
import {reduxForm}
  from 'redux-form'
import { connect }
...
class InputCountryCitizenship extends Component {
  ...
  navigateToNextScreen (name) {
    ...
    handleLocalAction({type: localActions.NAVIGATE_TO_NEXT_SCREEN, [COMMON_ENTITIES.SCREEN_TYPE]: nextScreen, [COMMON_ENTITIES.NAVIGATOR]: navigator, [USER_ENTITIES.RESIDENCY_TYPE]: residencyType, form: FORM_TYPES.ADD_USER, field: USER_ENTITIES.COUNTRY_CITIZENSHIP, value: name})
  }
